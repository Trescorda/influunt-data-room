    ...
    <div className="relative min-h-screen flex items-center justify-center p-4 overflow-hidden bg-inf-obsidian inf-on-dark">
      ...
      <div className="relative w-full max-w-2xl animate-fade-up">
        <div className="text-center mb-8">
          <img src="/influunt-lockup-dark.png" alt="Influunt" width={180} className="mx-auto mb-4" />
          <h1 className="text-2xl font-serif text-inf-gold-display">Non-Disclosure Agreement</h1>
          ...
          <div className="border-t border-white/10 pt-4">
            <label className="flex items-start gap-3 cursor-pointer mb-4">
              <input
                ...
                className="mt-1 w-4 h-4 rounded border-white/20 bg-inf-dark-input accent-inf-gold"
              />
