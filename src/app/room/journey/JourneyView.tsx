...
/**
 * Cover. Light throughout — the crest sits on paper with a soft gold bloom
 * rather than a dark cinematic band. No call-to-action buttons: this is a
 * tab inside the room, so "explore" and "go to the documents" are the
 * sidebar's job, not a hero's.
 */
function Hero() {
  return (
    <section className="relative flex items-center justify-center bg-inf-paper border-b border-inf-line overflow-hidden">
      {/* Soft gold bloom instead of a photographic scrim */}
      <div className="pointer-events-none absolute inset-0 flex items-start justify-center">
        <div className="w-[900px] h-[520px] rounded-full bg-inf-gold/[0.10] blur-[130px] -translate-y-1/3" />
      </div>

      <div className="relative z-10 max-w-4xl mx-auto px-6 md:px-10 w-full pt-20 pb-16 md:pt-24 md:pb-20 text-center">
        <Reveal variant="fade" duration={0.8}>
          <img src={CREST} alt="" className="h-14 w-14 object-contain mx-auto mb-7" />
          <p className="inf-eyebrow mb-5">The Investment Opportunity</p>
        </Reveal>

        <h1 className="text-4xl md:text-6xl font-bold leading-[1.08] tracking-tight mb-6 text-inf-green">
        ...
        <Reveal delay={0.25}>
          <p className="text-lg md:text-xl text-inf-muted max-w-2xl mx-auto leading-relaxed">
